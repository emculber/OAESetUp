...
do
	...
	~/OAE/apache-cassandra-2.1.2/bin/cassandra
	#------------------------
	...
	sudo apt-get install -y build-essential #Dependencies
	...
	#START ELASTICDEARCH
	~/OAE/elasticsearch-1.1.2/bin/elasticsearch &
	#--------------------------
    ...
    then	
	#GraphicsMagick-----------------
	sudo apt-get install -y libpng12-dev libjpeg-dev ghostscript
